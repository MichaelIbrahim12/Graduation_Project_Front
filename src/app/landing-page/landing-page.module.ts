...
@NgModule({
  declarations: [
    SearchComponent,
    MainLandingContentComponent,FooterComponent, AboutUsComponent, NavbarComponent,OurServicesComponent, DashboardComponent
  ],
  imports: [
    CommonModule,RouterModule,BuyModule,FormsModule,NgxPaginationModule
  ],
  exports:[
    SearchComponent,NavbarComponent,FooterComponent,DashboardComponent,AboutUsComponent
  ]
})
